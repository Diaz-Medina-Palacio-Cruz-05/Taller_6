...
public class PanelBotones extends JPanel implements ActionListener
{
	...
	public PanelBotones(InterfazLibreria interfazLibreria)
	{
		...
		agregarBoton(RENOMBRAR_CATEGORIA, "Renombrar Categoria", "./data/iconos/renombrar.png");
		agregarBoton(ELIMINAR_LIBROS, "Eliminar Libros de Autor", "./data/iconos/icono_eliminar.png");
	}
